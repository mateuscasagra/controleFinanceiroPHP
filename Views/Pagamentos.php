        ...
        <div class="col d-flex flex-column">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="/controleFinanceiroPHP/pagamento/adicionaPagamento" method="post">
                                <div class="mb-3">
            ...
            <div class="modal fade" id="editaModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="exampleModalLabel">Edite o pagamento</h1>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <form action="/controleFinanceiroPHP/pagamento/editaPagamento" method="post">
                                <div class="mb-3">
            ...
            <div class="container-fluid mt-4 mb-4 d-block flex-grow-1">
                ...
                <div class="card shadow h-100">
                    <div class="card-header py-3">
                        <h6 class="m-0 fw-bold text-black">Pagamentos</h6>
                    </div>
                                                        ...
                                                        <td>
                                                            <div class="d-flex justify-content-center">
                                                                <div class="d-flex">
                                                                    ...
                                                                    <form
                                                                        action="/controleFinanceiroPHP/pagamento/excluiPagamento"
                                                                        method="post">
                                                                        <button name="Id" value="<?=$pagamento->Id?>" class="border-0 shadow-none bg-transparent"><i
